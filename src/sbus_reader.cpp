...
int Sbus_reader::NormalizeChannel(int16_t channel)
{
...
int Sbus_reader::isChannelActive(int16_t channel)
{
    if (channel < 0 || channel >= bfs::SbusData::NUM_CH)
    {
    ...
    int raw_val = sbus_data.ch[channel];
    return raw_val > SBUS_CENTER ? 1 : 0;
}
...
int Sbus_reader::get_throttle() { return data[0]; }
int Sbus_reader::get_yaw() { return data[1]; }
int Sbus_reader::get_pitch() { return data[2]; }
int Sbus_reader::get_roll() { return data[3]; }
int Sbus_reader::get_arm_status() { return data[4]; }
int Sbus_reader::get_mode() { return data[5]; }
int *Sbus_reader::get_data() { return data; }
